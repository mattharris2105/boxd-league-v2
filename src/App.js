...
{film.trailer && <button style={{...S.btn, background:'#12141A', border:'1px solid #2A2F3C', color:'#4A5168', width:'100%', fontSize:'9px', marginBottom:'8px'}} onClick={e => { e.stopPropagation(); window.open(film.trailer.replace('https://www.youtube.com/embed/','https://www.youtube.com/watch?v='), '_blank') }}>▶ Watch Trailer</button>}
{owned
